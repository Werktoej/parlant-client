...
const defaultLightColors = {
  ...
  'btn-warning': '38 92% 50%',
  'btn-warning-foreground': '0 0% 10%',
  'btn-info': '200 85% 45%',
  'btn-info-foreground': '0 0% 100%',
  'btn-neutral': '220 10% 50%',
  'btn-neutral-foreground': '0 0% 100%',
};
...
const defaultDarkColors = {
  ...
  radius: '0.375rem',
  // Button variants
  'btn-success': '142 65% 40%',
  'btn-success-foreground': '0 0% 100%',
  'btn-danger': '0 62% 50%',
  'btn-danger-foreground': '0 0% 100%',
  'btn-warning': '38 85% 50%',
  'btn-warning-foreground': '0 0% 10%',
  'btn-info': '200 75% 50%',
  'btn-info-foreground': '0 0% 100%',
  'btn-neutral': '220 10% 45%',
  'btn-neutral-foreground': '0 0% 100%',
};
...
export const themePresets: Record<string, ThemeConfig> = {
  ...
  ocean: {
    ...
    light: {
      ...
      radius: '0.375rem',
      // Button variants
      'btn-success': '160 70% 40%',
      'btn-success-foreground': '0 0% 100%',
      'btn-danger': '5 70% 50%',
      'btn-danger-foreground': '0 0% 100%',
      'btn-warning': '38 90% 50%',
      'btn-warning-foreground': '0 0% 10%',
      'btn-info': '185 75% 40%',
      'btn-info-foreground': '0 0% 100%',
      'btn-neutral': '200 15% 50%',
      'btn-neutral-foreground': '0 0% 100%',
    },
    dark: {
      background: '200 30% 8%',
  ...
  sunset: {
    ...
    light: {
      ...
      radius: '0.375rem',
      // Button variants
      'btn-success': '140 70% 42%',
      'btn-success-foreground': '0 0% 100%',
      'btn-danger': '345 75% 50%',
      'btn-danger-foreground': '0 0% 100%',
      'btn-warning': '35 85% 55%',
      'btn-warning-foreground': '0 0% 10%',
      'btn-info': '200 80% 48%',
      'btn-info-foreground': '0 0% 100%',
      'btn-neutral': '20 12% 50%',
      'btn-neutral-foreground': '0 0% 100%',
    },
    dark: {
      background: '20 25% 6%',
      ...
      radius: '0.375rem',
      // Button variants
      'btn-success': '140 65% 45%',
      'btn-success-foreground': '0 0% 100%',
      'btn-danger': '345 70% 55%',
      'btn-danger-foreground': '0 0% 100%',
      'btn-warning': '35 80% 55%',
      'btn-warning-foreground': '0 0% 10%',
      'btn-info': '200 75% 50%',
      'btn-info-foreground': '0 0% 100%',
      'btn-neutral': '20 12% 45%',
      'btn-neutral-foreground': '0 0% 100%',
    },
  },
  ...
  purple: {
    ...
    light: {
      ...
      radius: '0.375rem',
      // Button variants
      'btn-success': '145 70% 40%',
      'btn-success-foreground': '0 0% 100%',
      'btn-danger': '0 70% 50%',
      'btn-danger-foreground': '0 0% 100%',
      'btn-warning': '45 85% 52%',
      'btn-warning-foreground': '0 0% 10%',
      'btn-info': '240 70% 55%',
      'btn-info-foreground': '0 0% 100%',
      'btn-neutral': '270 15% 50%',
      'btn-neutral-foreground': '0 0% 100%',
    },
    dark: {
      ...
      radius: '0.375rem',
      // Button variants
      'btn-success': '145 65% 45%',
      'btn-success-foreground': '0 0% 100%',
      'btn-danger': '0 65% 55%',
      'btn-danger-foreground': '0 0% 100%',
      'btn-warning': '45 80% 55%',
      'btn-warning-foreground': '0 0% 10%',
      'btn-info': '240 65% 60%',
      'btn-info-foreground': '0 0% 100%',
      'btn-neutral': '270 12% 45%',
      'btn-neutral-foreground': '0 0% 100%',
    },
  },
  ...
  petroleum: {
    ...
    light: {
      ...
      'btn-success': '142 65% 40%',
      'btn-success-foreground': '0 0% 100%',
      'btn-danger': '345 82% 40%',
      'btn-danger-foreground': '0 0% 100%',
      'btn-warning': '38 90% 48%',
      'btn-warning-foreground': '0 0% 10%',
      'btn-info': '217 50% 50%',
      'btn-info-foreground': '0 0% 100%',
      'btn-neutral': '220 10% 50%',
